...
class Import extends Component
{
    ...
    public function downloadTemplate()
    {
        return response()->streamDownload(function () {
            ...
            echo "12345,0012345678,Contoh Siswa,IPA,10,IPA 1,siswa@contoh.com,08123456789,2005-01-01,Jl. Contoh No. 1\n";
    ...
    public function import()
    {
        ...
        try {
            ...
            Log::info("User ID " . Auth::id() . " imported {$count} students.");
            ...
            return redirect()->route('sekolah.siswa.index');
    ...
    {
        return view('livewire.sekolah.student.import')
