                    ...
                    <div
                        ...
                        <div class="d-flex gap-2 align-items-center flex-wrap">
                            ...
                            @if($filterGrade || $filterMajor || $filterPhoto)
                                <button wire:click="$set('filterGrade', ''); $set('filterMajor', ''); $set('filterPhoto', '')" 
                                ...
                                <tbody>
                                    @forelse($students as $student)
                                        <tr>
                                            ...
                                            <td>
                                                <button onclick="showMagicLinkModal('{{ $student->name }}', '{{ route('student.public.profile', $student->magic_token) }}')"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <small class="text-muted">Siswa dapat mengakses profilnya melalui link atau scan QR Code di atas.</small>
                </div>
                <div class="modal-footer">
