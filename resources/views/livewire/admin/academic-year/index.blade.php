                                ...
                                <tbody>
                                    @forelse($academicYears as $year)
                                        <tr>
                                            ...
                                            <td><span class="text-capitalize">{{ $year->semester }}</span></td>
                                            ...
                                            <td>
                                                <button wire:click="edit({{ $year->id }})" class="btn btn-sm btn-icon btn-action-primary">
                                                    <i class="fi fi-rr-edit"></i>
                                                </button>
                                                <button wire:click="delete({{ $year->id }})" class="btn btn-sm btn-icon btn-action-danger" onclick="confirm('Apakah Anda yakin ingin menghapus data ini?') || event.stopImmediatePropagation()">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="{{ $isEdit ? 'update' : 'store' }}">
                        <div class="mb-3">
                            <label for="year_name" class="form-label">Tahun Pelajaran (YYYY/YYYY) <span class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('year_name') is-invalid @enderror" id="year_name" wire:model="year_name" placeholder="Contoh: 2023/2024">
                            @error('year_name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="start_date" class="form-label">Tanggal Awal <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted d-block mt-1">Hanya satu tahun pelajaran yang boleh aktif dalam satu waktu.</small>
                        </div>
